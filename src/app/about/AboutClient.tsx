...
export default function AboutClient() {
  ...
  const currentBadges: string[] = (translations as any)[language || 'en']?.about?.badges || (translations as any)['en'].about.badges;
    ...
    <main className="flex-1 bg-surface py-20 overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">{t('about.headerTitle')}</h1>
          <p className="text-xl text-neutral-600 font-inter">{t('about.headerSubtitle')}</p>
        </div>
        ...
        <div className="mt-24 pt-16 border-t border-neutral-200">
          <h2 className="text-3xl font-bold text-center text-primary mb-12">{t('about.certificationsTitle')}</h2>
          <div className="flex flex-wrap justify-center gap-10">
            {currentBadges.map((badge: string, idx: number) => (
