...
export default function AddToCartSection({ product }: { product: { slug: string, name: string, image: string, sizes: string[], pricePerLiter: number } }) {
  const { slug, name, image, sizes, pricePerLiter } = product;
      ...
      <div className="flex items-center gap-4 pt-2">
        <div className="flex items-center border border-neutral-200 rounded-lg overflow-hidden h-14 bg-white shrink-0">
          <button 
            ...
            className="px-4 text-neutral-500 hover:bg-neutral-50 hover:text-primary transition-colors h-full text-lg w-12 flex justify-center items-center"
          >
            -
          </button>
        ...
        <button 
          ...
          className="flex-1 h-14 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2 lift-effect shadow-md shadow-primary/20"
        >
